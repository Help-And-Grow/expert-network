...
- **AI:** Pluggable providers via `AI_PROVIDER` (default `qwen`): DashScope/Qwen, Gemini via Vertex AI, OpenAI, Z.ai (Vertex Model Garden), BytePlus ModelArk, Volcengine ModelArk, Tencent Hunyuan. Memory backend (`MEMORY_BACKEND`): `mem9 | pgvector | hybrid`.
