# Help & Grow — investor & GTM brief

**Purpose:** One-page, logic-first introduction for investors and go-to-market planning. Canonical brand: [`../BRAND.md`](../BRAND.md).
...
## 3. Vision (north star): *service as agent*
...
- **Geographic wedge:** **Singapore & Southeast Asia** (legal, talent, BD, fundraising, GTM for AI-era companies).
- **Expansion:** Same product pattern applies to other regions and verticals once liquidity and brand exist in the wedge.

---

## 6. Business model (high level)

- **Take rate** on paid sessions (Stripe Connect–style marketplace).
- **Optional:** token-based discounts and engagement mechanics (H&G token) to deepen retention and referrals.
- **Longer term:** monetization adjacent to **agent** capabilities (e.g. premium automation), without breaking the human trust core.

---

## 7. Traction & proof (fill in for each conversation)
...
## 8. GTM logic (sequenced)

1. **Liquidity in one wedge** — dense expert supply + clear “jobs to be done” (e.g. AI founders in SG/SEA).
2. **Invite / quality bar** — protect trust early; expand codes as supply absorbs demand.
3. **Channel fit** — Telegram + WeChat for distribution; web for depth and SEO.
4. **Content & community** — “learning by doing, growing by helping” as repeatable story, not one-off campaigns.
5. **Agent narrative** — land *service as agent* with design partners before broad horizontal claims.

---

## 9. Risks (investor diligence)
...
## 10. Ask (customize per meeting)

- **Investor:** round size, use of funds (product, GTM, key hires), 18–24 month milestones tied to liquidity and revenue.
- **GTM partner:** ICP, channel commitments, co-marketing, pilot cohort size.

---

*Last updated: product branding pass (Help & Grow — AI Native Expert Network).*
